...
```
 ~/Desktop/ssti-payloads:~# git clone https://github.com/Himangshu30/SERVER-SIDE-TEMPLATE-INJECTION-PAYLOADS
```

##### Cloning an Existing Repository ( Clone with SSH )
```
 ~/Desktop/ssti-payloads:~# git clone git@github.com/Himangshu30/SERVER-SIDE-TEMPLATE-INJECTION-PAYLOADS
```
